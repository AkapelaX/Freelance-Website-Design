"use strict";
    ...
    function bindControls(){
      ...
      byId("publishBtn").addEventListener("click",function(){
        ...
        if(state.project.domainMode === "custom" && !state.project.dnsVerified){
          switchTab("project");
          showToast("Connect and verify your custom domain before publishing.");
          return;
        }

        state.backend.published = true;
        saveDraft(false);
        showToast("Publish simulation complete: " + getPublishedUrl());
      });
